...
//: The half-open range operator (`..<`) doesn’t include the upper number, so this range goes from `0` to `4` for a total of five loop iterations. Use the _closed range operator_ ( `...`) to make a range that includes both values.
//:
var secondForLoop = 0
for _ in 0...4 {
    secondForLoop += 1
